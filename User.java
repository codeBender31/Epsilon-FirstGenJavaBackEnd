...
public User(String firstName, String lastName, int gradeLevel, String username, String email, String password, Arithmetic arithmetic, Reading reading, Finance finance, Fitness fitness) {
    ...
    this.finance = finance; // Assign the provided Finance object\
    this.fitness = fitness; // Assign the provided Fitness object
  }
